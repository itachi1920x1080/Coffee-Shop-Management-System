...
* **Auth & Roles:** សម្រាប់ចុះឈ្មោះ ចូលប្រើប្រាស់ និងគ្រប់គ្រងសិទ្ធិ (Admin, Manager, Cashier)។
* **Staff Management:** គ្រប់គ្រងបុគ្គលិក កំណត់តួនាទី និងពាក្យសម្ងាត់ (សម្រាប់តែ Admin)។
...
## 🛡️ សិទ្ធិប្រើប្រាស់ និងតួនាទី (Role-Based Access Control - RBAC)

ប្រព័ន្ធរបស់យើងបែងចែកអ្នកប្រើប្រាស់ជា ៣ តួនាទីសំខាន់ៗ ដើម្បីធានាសុវត្ថិភាពទិន្នន័យ៖

1. **Admin:** មានសិទ្ធិពេញលេញលើប្រព័ន្ធទាំងមូល រួមទាំងការបង្កើត/លុបគណនីបុគ្គលិក និងកំណត់តួនាទី (Staff Management)។ Backend ប្រើប្រាស់ `get_current_admin` ដើម្បីការពារ Endpoints ទាំងនេះ។
2. **Manager:** អាចមើលឃើញ Dashboard, ទាញយករាយការណ៍ (Reports), គ្រប់គ្រងបញ្ជីមុខម្ហូប និងគ្រប់គ្រងការចំណាយ។ (មិនមានសិទ្ធិគ្រប់គ្រងបុគ្គលិកទេ)។
3. **Cashier:** មានសិទ្ធិតែក្នុងការប្រើប្រាស់ប្រព័ន្ធលក់ (Point of Sale - POS), បង្កើតការបញ្ជាទិញ (Orders) និងទូទាត់ប្រាក់ប៉ុណ្ណោះ។

ការកំណត់សិទ្ធិនេះត្រូវបានត្រួតពិនិត្យយ៉ាងតឹងរ៉ឹងពីខាង Backend API (បោះ 403 Forbidden Error ប្រសិនបើគ្មានសិទ្ធិ) និងត្រូវបានលាក់ Menu ពីខាង Frontend។
